...
class Network:
    ...
    def simulate_max_time(self, optimizer, max_time=10000, file_name="log/information_log.csv"):
        file_name = "./log/Q_learning2nd/thaydoisonode/information_log" + str(self.index) +".csv"
        filenametxt = "./log/Q_learning2nd/thaydoisonode/networkinfor" + str(self.index) +".txt"
